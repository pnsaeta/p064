...
\\]
You can readily verify that each time derivative brings down another factor of $$(-i\omega)$$, so that the Fourier transform of <a href="">Equation \ref{eq:DDSHO2}</a>