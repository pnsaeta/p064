...
the frequency of an oscillator to its *natural frequency*. (You’ll learn lots
more about this later in the course and next year in E79.)
...
#+caption: Stronger damping attenuates the resonance peak.
#+name: fig:intro-3
[[../img/intro-3.png]]
...
#+caption: Now our resonance cup runneth over!
#+name: fig:intro-4
[[../img/intro-4.png]]
...
#+caption: Now our resonance cup runneth over in style!
#+name: fig:intro-5
[[../img/intro-5.png]]
...
#+caption: Displaying a pandas DataFrame.
#+name: fig:pandas
[[../img/intro-pandas.png]]
...
#+caption: With the curves in a pandas DataFrame, the plot command takes a single line.
#+name: fig:intro-6
...
#+caption: Target practice: Can you make your plot look *exactly* like this one?
#+name: fig:target
#+attr_html: :width px
[[../img/moore.png]]
...
1. You can load the data into a convenient data structure defined by pandas with
   some code like 
...
2. The command to plot with error bars is ~ax.errorbar(xvals, yvals, yerrors)~
...
3. Potentially interesting keywords:
    - ~marker~
    - ~fmt~
    - ~markersize~
    - ~capsize~
