...
- Taking the complex conjugate of this equation gives $$b_i^* = \sum_{j=1}^N A_{ij}^* a_j^* = \sum_{j=1}^N a_j^* A_{ji} $$, where I have used that the adjoint operation is represented by the conjugate transpose.
